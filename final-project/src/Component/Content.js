...
<content>
        ...
        p-4" >
        <div className="rounded-xl bg-yellow-300 w-auto sm:w-1/12 h-fit drop-shadow-xl">
                  <img
                    src={logo}
                    alt="ika"
                  />
    </div>
        <div className="text-center my-auto flex-col w-auto sm:w-1/2 p-5 rounded-lg">
    ...
    <div className=" my-auto flex-col w-auto sm:w-1/2 p-5 rounded-lg">
      <h1 className=" whitespace-nowrap text-xl p-2 font-semibold mx-auto bg-yellow-300 rounded-lg shadow-xl">" IFS-JOB CONNECT "</h1>
      <h2 className="bg-green-200 p-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, 
        sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
        Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
        Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
         Excepteur sint occaecat cupidatat non proident, 
